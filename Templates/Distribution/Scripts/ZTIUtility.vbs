...
Public Const Version = "6.3.8330.1001"
...
Class Utility
	...
	Public Sub PrepareEnvironment
		...
		If oEnvironment.Item("_SMSTSLogPath") <> "" then
			...
			oLogging.CreateEntry "The task sequencer log is located at " & oEnvironment.Item("_SMSTSLogPath") & "\SMSTS.LOG.  Please consult this log for issues within the Task Sequencer.", LogTypeInfo
		End if
